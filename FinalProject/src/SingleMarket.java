...
public class SingleMarket {
  ...
  public String showUserName(Connection connection) throws  SQLException {
    String username = "";
    Statement statement = connection.createStatement();
    String sql = "CALL GETMANAGERNAME()";
    ResultSet rs = statement.executeQuery(sql);
  ...
  public boolean addCoupon(int couponPWD, int couponAmount, Connection connection) throws SQLException {
    String sql0 = "SELECT managerName FROM manager";
    Statement statement = connection.createStatement();
    ResultSet rs = statement.executeQuery(sql0);
    String managerNameGET = "";
    while (rs.next()) {
      managerNameGET = rs.getString("managerName");
    }
    rs.close();
  ...
  public String[] showOnlineTransactions(Connection connection) throws SQLException {
    ...
    while (rs.next()) {
      ...
      String rowResult = "transacID: " + Integer.toString(transacID) + "     " +
              ...
              "CardPaymentID: " + Integer.toString(cardPaymentID) + "     "  + "packageID: " +
  ...
  public String[] showCoupons(Connection connection) throws SQLException {
    ArrayList<String> results = new ArrayList<>();
    String sql = "CALL SHOWCURRENTCOUPON()";
    Statement statement = connection.createStatement();
    ResultSet rs = statement.executeQuery(sql);
    while (rs.next()) {
      ...
      String managerName = rs.getString("managerNameIN");
      ...
      String rowResult = "couponID: " + Integer.toString(couponID) + "     " +
              ...
              "managerName: " + managerName + "     "  + "managerID: " + Integer.toString(managerID);
      results.add(rowResult);
    }
    rs.close();
    String[] realResultType = new String[results.size()];
  ...
  public String[] showAllCoupons(Connection connection) throws SQLException {
    ArrayList<String> results = new ArrayList<>();
  ...
  public String[] showAllCards(Connection connection) throws SQLException {
    ArrayList<String> results = new ArrayList<>();
    ...
    while (rs.next()) {
      ...
      int cardSerNum = rs.getInt("cardSerNum");
      String cardBank = rs.getString("cardBank");
      int cardAmount = rs.getInt("cardAmount");
      String rowResult = "cardID: " + Integer.toString(cardID) + "     " +
          "cardSerNum: " + Integer.toString(cardSerNum ) + "     "  +
          "cardBank: " + cardBank + "     " + "cardAmount: " + Integer.toString(cardAmount);
      results.add(rowResult);
    }
    rs.close();
    String[] realResultType = new String[results.size()];
  ...
  public String[] showAllCash(Connection connection) throws SQLException {
    ArrayList<String> results = new ArrayList<>();
    ...
    while (rs.next()) {
      int cashID = rs.getInt("cashID");
      int cahsAmount = rs.getInt("cahsAmount");
      String rowResult = "cashID: " + Integer.toString(cashID) + "     " +
          "cahsAmount: " + Integer.toString(cahsAmount );
      results.add(rowResult);
    }
    rs.close();
    String[] realResultType = new String[results.size()];
  ...
  public String[] showAllTransportations(Connection connection) throws SQLException {
    ArrayList<String> results = new ArrayList<>();
    ...
    while (rs.next()) {
      ...
      String shippingCompany = rs.getString("shippingCompany");
      String rowResult = "packageID: " + Integer.toString(packageID) + "     " +
          "destination: " + destination + "     "  +
          "receiverName: " + receiverName + "     " + "shippingCompany: " + shippingCompany;
      results.add(rowResult);
    }
    rs.close();
    String[] realResultType = new String[results.size()];
  ...
  public String[] showOnlineSaleItemsWithID(int transacID, Connection connection) throws SQLException {
    ArrayList<String> results = new ArrayList<>();
    String sql = "SELECT * FROM itemWithOnlineTransac WHERE transacID =" + Integer.toString(transacID);
    Statement statement = connection.createStatement();
    ResultSet rs = statement.executeQuery(sql);
    while (rs.next()) {
      int onlineItemsID = rs.getInt("onlineItemsID");
      int transacIDIN = rs.getInt("transacID");
      int ItemID = rs.getInt("ItemID");
      int ItemAmount = rs.getInt("ItemAmount");
      String rowResult = "onlineItemsID: " + Integer.toString(onlineItemsID) + "     " +
          "transacID: " + Integer.toString(transacIDIN) + "     " + "ItemID: " +
          Integer.toString(ItemID) + "     " + "ItemAmount: " + Integer.toString(ItemAmount);
      results.add(rowResult);
    }
    rs.close();
  ...
  public String[] showOfflineSaleItemsWithID(int transacID, Connection connection) throws SQLException {
    ArrayList<String> results = new ArrayList<>();
    String sql = "SELECT * FROM itemWithOfflineTransac WHERE transacID =" + Integer.toString(transacID);
    Statement statement = connection.createStatement();
    ResultSet rs = statement.executeQuery(sql);
    while (rs.next()) {
      int onlineItemsID = rs.getInt("offlineItemsID");
      int transacIDIN = rs.getInt("transacID");
      int ItemID = rs.getInt("ItemID");
      int ItemAmount = rs.getInt("ItemAmount");
      String rowResult = "onlineItemsID: " + Integer.toString(onlineItemsID) + "     " +
